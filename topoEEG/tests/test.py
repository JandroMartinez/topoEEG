...
def main():
    ...
    topoEEG_obj = tda(raw = raw, n_components=10, random_state=97, max_iter=1000, grid_size = 100, fmin=1, fmax=50, tmin=0, tmax=240)

    # Step 2: Compute ICA
    #topoEEG_obj.raw_clean = topoEEG_obj.compute_ica()
    topoEEG_obj.raw_clean = raw
    ...
    topoEEG_obj.classify_persistence_images()
